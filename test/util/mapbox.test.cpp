...
TEST(TrackAsia, CanonicalURL) {
    ...
    EXPECT_EQ("trackasia://tiles/tiles/{z}/{x}/{y}.pbf",
              mbgl::util::mapbox::canonicalizeTileURL(mapboxFixture::trackAsiaTileServerOptions,
                                                      "https://maps.track-asia.coms/{z}/{x}/{y}.pbf",
                                                      SourceType::Vector,
                                                      512));
}
