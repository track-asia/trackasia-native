...
cp -r trackasia-gl-js/test/integration/render-tests $BASE_DIR/test-data/integration/
cp -r trackasia-gl-js/test/integration/query-tests $BASE_DIR/test-data/integration/
