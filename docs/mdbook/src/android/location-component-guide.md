...
```kotlin
{{#include ../../../../platform/android/MapboxGLAndroidSDKTestApp/src/main/java/org/track-asia-vn/android/testapp/activity/location/BasicLocationPulsingCircleActivity.kt:top}}
```
...
```kotlin
{{#include ../../../../platform/android/MapboxGLAndroidSDKTestApp/src/main/java/org/track-asia-vn/android/testapp/activity/location/BasicLocationPulsingCircleActivity.kt:permission}}
```
...
```kotlin
{{#include ../../../../platform/android/MapboxGLAndroidSDKTestApp/src/main/java/org/track-asia-vn/android/testapp/activity/location/BasicLocationPulsingCircleActivity.kt:onMapReady}}
```
...
```kotlin
{{#include ../../../../platform/android/MapboxGLAndroidSDKTestApp/src/main/java/org/track-asia-vn/android/testapp/activity/location/BasicLocationPulsingCircleActivity.kt:LocationComponentActivationOptions}}
```
