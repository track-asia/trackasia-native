...
```kotlin
{{#include ../../../../platform/android/TrackasiaGLAndroidSDKTestApp/src/main/java/com.track-asia/android/testapp/activity/location/BasicLocationPulsingCircleActivity.kt:top}}
```
...
```kotlin
{{#include ../../../../platform/android/TrackasiaGLAndroidSDKTestApp/src/main/java/com.track-asia/android/testapp/activity/location/BasicLocationPulsingCircleActivity.kt:permission}}
```
...
```kotlin
{{#include ../../../../platform/android/TrackasiaGLAndroidSDKTestApp/src/main/java/com.track-asia/android/testapp/activity/location/BasicLocationPulsingCircleActivity.kt:onMapReady}}
```
...
```kotlin
{{#include ../../../../platform/android/TrackasiaGLAndroidSDKTestApp/src/main/java/com.track-asia/android/testapp/activity/location/BasicLocationPulsingCircleActivity.kt:LocationComponentActivationOptions}}
```
...
[Test APP]: https://github.com/track-asia/trackasia-native/tree/main/platform/android/TrackasiaGLAndroidSDKTestApp/src/main/java/com.track-asia/android/testapp/activity/location/BasicLocationPulsingCircleActivity.kt
