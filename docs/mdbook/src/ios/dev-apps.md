...
There are two iOS apps available in the repo that you can use for TrackAsia Native development. One Objective-C based app and a Swift based app.
...
This app is available as "TrackAsiaApp" in the [generated Xcode project](./README.md).
...
```
bazel run --//:renderer=metal //platform/ios/app-swift:TrackAsiaApp
```
