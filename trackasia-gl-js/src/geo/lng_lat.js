 ...
 *
 * TrackAsia GL uses longitude, latitude coordinate order (as opposed to latitude, longitude) to match GeoJSON.
 *
 * Note that any TrackAsia GL method that accepts a `LngLat` object as an argument or option
