...
const std::string AnnotationManager::SourceID = "com.trackasia.annotations";
const std::string AnnotationManager::PointLayerID = "com.trackasia.annotations.points";
const std::string AnnotationManager::ShapeLayerID = "com.trackasia.annotations.shape.";
...
// we prefix input image IDs with "com.trackasia.annotations".
