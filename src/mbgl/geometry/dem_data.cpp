...
const std::array<float, 4>& DEMData::getUnpackVector() const {
    ...
    static const std::array<float, 4> unpackTrackasia = {{ 6553.6f, 25.6f, 0.1f, 10000.0f }};
    // https://aws.amazon.com/public-datasets/terrain/
    static const std::array<float, 4> unpackTerrarium = {{ 256.0f, 1.0f, 1.0f / 256.0f, 32768.0f }};

    return encoding == Tileset::DEMEncoding::Terrarium ? unpackTerrarium : unpackTrackasia;
}
