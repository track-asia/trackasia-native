...
[![node-ci](https://github.com/track-asia-vn/maplibre-native/actions/workflows/node-ci.yml/badge.svg)](https://github.com/track-asia-vn/maplibre-native/actions/workflows/node-ci.yml)
...
Further platforms might work [with additional libraries installed](https://github.com/track-asia-vn/maplibre-native/tree/main/platform/linux#prerequisites).
...
The `kind` is an enum and defined in [`mbgl.Resource`](https://github.com/track-asia-vn/maplibre-native/blob/main/include/mbgl/storage/resource.hpp):
