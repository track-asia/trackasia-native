...
/**
 ...
 Each
 <a href="https://trackasia.com/trackasia-style-spec/#sources-image"><code>image</code></a>
 ...
 "https://trackasia.com/trackasia-gl-js-docs/assets/radar.gif")!) mapView.style?.addSource(source)
 ```
