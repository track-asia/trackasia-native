...
/**
 ...
 <a href="https://track-asia.com/trackasia-style-spec/expressions/#interpolate"><code>interpolate</code></a>
...
/**
 `NSExpression` variable that corresponds to the
 <a href="https://track-asia.com/trackasia-style-spec/expressions/#heatmap-density"><code>heatmap-density</code></a>
 expression operator in the TrackAsia Style Spec.
 */
...
/**
 `NSExpression` variable that corresponds to the
 <a href="https://track-asia.com/trackasia-style-spec/expressions/#line-progress"><code>line-progress</code></a>
 expression operator in the TrackAsia Style Spec.
 */
...
/**
 `NSExpression` variable that corresponds to the
 <a href="https://track-asia.com/trackasia-style-spec/expressions/#geometry-type"><code>geometry-type</code></a>
 expression operator in the TrackAsia Style Spec.
 */
...
/**
 `NSExpression` variable that corresponds to the
 <a href="https://track-asia.com/trackasia-style-spec/expressions/#properties"><code>properties</code></a>
 expression operator in the TrackAsia Style Spec.
 */
