...
- (void)testSources {
    ...
    if ([initialSources.anyObject.identifier isEqualToString:@"com.trackasia.annotations"]) {
...
- (void)testLayers {
    ...
    if ([initialLayers.firstObject.identifier isEqualToString:@"com.trackasia.annotations.points"]) {
...
- (void)testLayersOrder {
    ...
    if ([layers.firstObject.identifier isEqualToString:@"com.trackasia.annotations.points"]) {
        startIndex++;
    }
