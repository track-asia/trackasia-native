...
* On step 2, choose Instrumentation, test filter is `com.trackasia.trackasiagl.testapp.MainActivityTest` and upload the APK in `mapbox-gl-native/android/java/TrackasiaGLAndroidSDKTestApp/build/outputs/apk/TrackasiaGLAndroidSDKTestApp-debug-androidTest-unaligned.apk`
...
On Step 2, you can also separate by commas different classes: `com.trackasia.trackasiagl.testapp.MainActivityTest,com.trackasia.trackasiagl.testapp.MainActivityScreenTest`
...
```
$ adb shell monkey -p com.trackasia.trackasiagl.testapp -v 500
```
