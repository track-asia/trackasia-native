...
import { camelize, camelizeWithLeadingLowercase, iff, snakeCaseUpper, writeIfModified } from "../../../scripts/style-code.mjs";
...
const lightJava = ejs.compile(fs.readFileSync(absPath('TrackAsiaAndroid/src/main/java/com/trackasia/android/style/light/light.java.ejs'), 'utf8'), { strict: true });
const lightJavaUnitTests = ejs.compile(fs.readFileSync(absPath('TrackAsiaAndroidTestApp/src/androidTest/java/com/trackasia/android/testapp/style/light.junit.ejs'), 'utf8'), { strict: true });
writeIfModified(absPath(`TrackAsiaAndroid/src/main/java/com/trackasia/android/style/light/Light.java`), lightJava({ properties: lightProperties }));
writeIfModified(absPath(`TrackAsiaAndroidTestApp/src/androidTest/java/com/trackasia/android/testapp/style/LightTest.java`), lightJavaUnitTests({ properties: lightProperties }));

// Java
const layerJava = ejs.compile(fs.readFileSync(absPath('TrackAsiaAndroid/src/main/java/com/trackasia/android/style/layers/layer.java.ejs'), 'utf8'), { strict: true });
const layerJavaUnitTests = ejs.compile(fs.readFileSync(absPath('TrackAsiaAndroidTestApp/src/androidTest/java/com/trackasia/android/testapp/style/layer.junit.ejs'), 'utf8'), { strict: true });

for (const layer of layers) {
  var srcDir = 'TrackAsiaAndroid/src/main/java/com/trackasia/android/style/layers/'
  var testDir = 'TrackAsiaAndroidTestApp/src/androidTest/java/com/trackasia/android/testapp/style/'
  if (layer.type === 'location-indicator') {
    srcDir = 'TrackAsiaAndroid/src/main/java/com/trackasia/android/location/'
    testDir = 'TrackAsiaAndroidTestApp/src/androidTest/java/com/trackasia/android/location/'
  }
...
// Jni
const layerHpp = ejs.compile(fs.readFileSync(absPath('TrackAsiaAndroid/src/cpp/style/layers/layer.hpp.ejs'), 'utf8'), { strict: true });
const layerCpp = ejs.compile(fs.readFileSync(absPath('TrackAsiaAndroid/src/cpp/style/layers/layer.cpp.ejs'), 'utf8'), { strict: true });

for (const layer of layers) {
  const layerFileName = layer.type.replace('-', '_');

  writeIfModified(absPath(`TrackAsiaAndroid/src/cpp/style/layers/${layerFileName}_layer.hpp`), layerHpp(layer));
  writeIfModified(absPath(`TrackAsiaAndroid/src/cpp/style/layers/${layerFileName}_layer.cpp`), layerCpp(layer));
}

// Java PropertyFactory
const propertyFactoryTemplate = ejs.compile(fs.readFileSync(absPath('TrackAsiaAndroid/src/main/java/com/trackasia/android/style/layers/property_factory.java.ejs'), 'utf8'), { strict: true });

const propertyFactorySrcDir = absPath('TrackAsiaAndroid/src/main/java/com/trackasia/android/style/layers/PropertyFactory.java')
writeIfModified(
...
const locationPropertyFactorySrcDir = absPath('TrackAsiaAndroid/src/main/java/com/trackasia/android/location/LocationPropertyFactory.java')
writeIfModified(
...
// Java Property
const enumPropertyJavaTemplate = ejs.compile(fs.readFileSync(absPath('TrackAsiaAndroid/src/main/java/com/trackasia/android/style/layers/property.java.ejs'), 'utf8'), { strict: true });
writeIfModified(
  absPath(`TrackAsiaAndroid/src/main/java/com/trackasia/android/style/layers/Property.java`),
