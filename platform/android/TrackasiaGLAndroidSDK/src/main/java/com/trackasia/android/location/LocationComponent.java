 ...
 * {@link com.trackasia.android.location.engine.MapboxFusedLocationEngineImpl}.
...
public final class LocationComponent {
   ...
   * {@link com.trackasia.android.maps.TrackasiaMap.OnMapClickListener#onMapClick(LatLng)} is going to be consumed
   ...
   * {@link com.trackasia.android.maps.TrackasiaMap.OnMapLongClickListener#onMapLongClick(LatLng)} is going to be consumed
   * and not pushed to the listeners registered after the component's activation.
   *
   * @param listener The location click listener that is invoked when the
   *                 location is clicked
