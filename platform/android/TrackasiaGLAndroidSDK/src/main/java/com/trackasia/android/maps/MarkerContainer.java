...
class MarkerContainer implements Markers {
  ...
  @Override
  public void update(@NonNull Marker updatedMarker, @NonNull TrackasiaMap mapboxMap) {
  ...
  private void ensureIconLoaded(Marker marker, @NonNull TrackasiaMap mapboxMap) {
