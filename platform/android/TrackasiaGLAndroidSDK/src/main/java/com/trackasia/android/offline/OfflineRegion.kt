...
class OfflineRegion @Keep private constructor(offlineRegionPtr: Long, fileSource: FileSource, idParam: Long, definition: OfflineRegionDefinition, metadata: ByteArray) {
   ...
   */
     ...
     * [com.trackasia.android.offline.OfflineManager.createOfflineRegion] instead.
     */
    init {
     ...
     * occurs automatically ([com.trackasia.android.offline.OfflineManager.runPackDatabaseAutomatically])
     *
     *
