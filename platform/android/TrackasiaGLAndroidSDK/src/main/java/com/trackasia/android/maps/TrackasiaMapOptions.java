...
public class TrackasiaMapOptions implements Parcelable {
  ...
  static TrackasiaMapOptions createFromAttributes(@NonNull TrackasiaMapOptions mapboxMapOptions,
    ...
    try {
      ...
      // deprecated
      mapboxMapOptions.apiBaseUrl(typedArray.getString(R.styleable.trackasia_MapView_trackasia_apiBaseUrl));
      ...
      mapboxMapOptions.maxZoomPreference(typedArray.getFloat(R.styleable.trackasia_MapView_trackasia_cameraZoomMax,
        TrackasiaConstants.MAXIMUM_ZOOM));
      mapboxMapOptions.minZoomPreference(typedArray.getFloat(R.styleable.trackasia_MapView_trackasia_cameraZoomMin,
        TrackasiaConstants.MINIMUM_ZOOM));
      mapboxMapOptions.maxPitchPreference(typedArray.getFloat(R.styleable.trackasia_MapView_trackasia_cameraPitchMax,
        TrackasiaConstants.MAXIMUM_PITCH));
      mapboxMapOptions.minPitchPreference(typedArray.getFloat(R.styleable.trackasia_MapView_trackasia_cameraPitchMin,
        TrackasiaConstants.MINIMUM_PITCH));

      mapboxMapOptions.compassEnabled(typedArray.getBoolean(R.styleable.trackasia_MapView_trackasia_uiCompass, true));
      mapboxMapOptions.compassGravity(typedArray.getInt(R.styleable.trackasia_MapView_trackasia_uiCompassGravity,
      ...
      mapboxMapOptions.logoEnabled(typedArray.getBoolean(R.styleable.trackasia_MapView_trackasia_uiLogo, true));
      mapboxMapOptions.logoGravity(typedArray.getInt(R.styleable.trackasia_MapView_trackasia_uiLogoGravity,
