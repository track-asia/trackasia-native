...
class TrackasiaMapOptionsTest {
    @Test
    fun testSanity() {
        Assert.assertNotNull("should not be null", TrackasiaMapOptions())
    }
    ...
    fun testCompassMargins() {
        Assert.assertTrue(
            Arrays.equals(
                intArrayOf(0, 1, 2, 3),
                TrackasiaMapOptions().compassMargins(intArrayOf(0, 1, 2, 3)).compassMargins
            )
        )
        Assert.assertFalse(
            Arrays.equals(
                intArrayOf(0, 1, 2, 3),
                TrackasiaMapOptions().compassMargins(intArrayOf(0, 0, 0, 0)).compassMargins
            )
        )
    }
    ...
    fun testLogoMargins() {
        Assert.assertTrue(
            Arrays.equals(
                intArrayOf(0, 1, 2, 3),
                TrackasiaMapOptions().logoMargins(intArrayOf(0, 1, 2, 3)).logoMargins
            )
        )
        Assert.assertFalse(
            Arrays.equals(
                intArrayOf(0, 1, 2, 3),
                TrackasiaMapOptions().logoMargins(intArrayOf(0, 0, 0, 0)).logoMargins
            )
        )
    }
    ...
    fun testAttributionMargins() {
        Assert.assertTrue(
            Arrays.equals(
                intArrayOf(0, 1, 2, 3),
                TrackasiaMapOptions().attributionMargins(intArrayOf(0, 1, 2, 3)).attributionMargins
            )
        )
        Assert.assertFalse(
            Arrays.equals(
                intArrayOf(0, 1, 2, 3),
                TrackasiaMapOptions().attributionMargins(intArrayOf(0, 0, 0, 0)).attributionMargins
            )
        )
    }
