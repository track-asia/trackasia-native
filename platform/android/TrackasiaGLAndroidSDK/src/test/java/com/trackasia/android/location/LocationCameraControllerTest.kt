...
import com.trackasia.android.location.MapboxAnimator.AnimationsValueChangeListener
...
class LocationCameraControllerTest {
    ...
    fun setCameraMode_mapTransitionsAreCancelled() {
        val mapboxMap = Mockito.mock(TrackasiaMap::class.java)
    ...
    private fun buildCamera(mapboxMap: TrackasiaMap): LocationCameraController {
        val transform = Mockito.mock(
            Transform::class.java
        )
        val moveGestureDetector = Mockito.mock(
    ...
    private fun buildCamera(mapboxMap: TrackasiaMap, transform: Transform): LocationCameraController {
        Mockito.`when`(mapboxMap.uiSettings).thenReturn(
            Mockito.mock(
                UiSettings::class.java
            )
