...
public class TrackasiaMapAction implements ViewAction {
  ...
  public TrackasiaMapAction(OnInvokeActionListener invokeViewAction, TrackasiaMap mapboxMap) {
  ...
  public static void invoke(TrackasiaMap mapboxMap, OnInvokeActionListener invokeViewAction) {
    onView(withId(android.R.id.content)).perform(new TrackasiaMapAction(invokeViewAction, mapboxMap));
  }
