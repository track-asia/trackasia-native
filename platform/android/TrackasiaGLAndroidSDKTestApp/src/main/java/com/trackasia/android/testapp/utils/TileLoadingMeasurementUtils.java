...
import static com.trackasia.android.constants.TrackasiaConstants.DEFAULT_MEASURE_TILE_DOWNLOAD_ON;
import static com.trackasia.android.constants.TrackasiaConstants.KEY_META_DATA_MEASURE_TILE_DOWNLOAD_ON;
...
public class TileLoadingMeasurementUtils {
  ...
  private static boolean isBooleanMetaDataValueOn(@NonNull String propKey, boolean defaultValue) {
    ...
    try {
      ...
      Context context = Trackasia.getApplicationContext();
  ...
  static class TileLoadingInterceptor implements Interceptor {
    ...
    private static String getRam() {
      ActivityManager actManager =
              (ActivityManager) Trackasia.getApplicationContext().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    private static String getWindowSize() {
      WindowManager windowManager =
              (WindowManager) Trackasia.getApplicationContext().getSystemService(Context.WINDOW_SERVICE);
    ...
    private static String getConnectionState() {
      Context appContext = Trackasia.getApplicationContext();
