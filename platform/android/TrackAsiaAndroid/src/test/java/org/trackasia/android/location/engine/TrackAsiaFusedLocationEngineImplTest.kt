...
class TrackAsiaFusedLocationEngineImplTest {
    @Mock
    ...
    fun setUp() {
        ...
        trackasiaFusedLocationEngineImpl = TrackAsiaFusedLocationEngineImpl(context)
        engine = LocationEngineProxy(trackasiaFusedLocationEngineImpl)
    }
    ...
    fun requestLocationUpdatesOutdoors() {
        val request =
            LocationEngineRequest.Builder(10)
