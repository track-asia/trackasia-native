...
class CameraPositionTest {
    ...
    fun testTypedArrayBuilder() {
        ...
        Mockito
            .`when`(typedArray.getFloat(R.styleable.trackasia_MapView_trackasia_cameraZoom, 0.0f))
            .thenReturn(zoom)
        Mockito
            .`when`(typedArray.getFloat(R.styleable.trackasia_MapView_trackasia_cameraTilt, 0.0f))
            .thenReturn(tilt)
