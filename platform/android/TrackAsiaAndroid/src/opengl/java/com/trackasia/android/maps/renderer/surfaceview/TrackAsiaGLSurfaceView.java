...
public class TrackAsiaGLSurfaceView extends TrackAsiaSurfaceView {

  protected final WeakReference<TrackAsiaGLSurfaceView> viewWeakReference = new WeakReference<>(this);
   ...
   */
  static class GLThread extends TrackAsiaSurfaceView.RenderThread {
    GLThread(WeakReference<TrackAsiaGLSurfaceView> surfaceViewWeakRef) {
    ...
    protected void guardedRun() throws InterruptedException {
      ...
      try {
        ...
        while (true) {
          synchronized (renderThreadManager) {
            while (true) {
              ...
              if (pausing && haveEglContext) {
                TrackAsiaGLSurfaceView view = mSurfaceViewWeakRef.get();
          ...
          if (createEglContext) {
            TrackAsiaSurfaceView view = mSurfaceViewWeakRef.get();
            if (view != null) {
     ...
     */
    protected WeakReference<TrackAsiaGLSurfaceView> mSurfaceViewWeakRef;
  }
}
