...
public:
    static constexpr auto Name() { return "org/trackasia/android/offline/OfflineRegionDefinition"; };
...
public:
    using SuperTag = OfflineRegionDefinition;
    static constexpr auto Name() { return "org/trackasia/android/offline/OfflineGeometryRegionDefinition"; };
