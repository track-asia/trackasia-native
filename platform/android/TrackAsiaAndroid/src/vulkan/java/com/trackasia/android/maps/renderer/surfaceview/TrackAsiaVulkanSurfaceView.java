...
public class TrackAsiaVulkanSurfaceView extends TrackAsiaSurfaceView {

  protected final WeakReference<TrackAsiaVulkanSurfaceView> viewWeakReference = new WeakReference<>(this);

  public TrackAsiaVulkanSurfaceView(Context context) {
    super(context);
  }

  public TrackAsiaVulkanSurfaceView(Context context, AttributeSet attrs) {
    super(context, attrs);
  }
  ...
  static class VulkanThread extends TrackAsiaSurfaceView.RenderThread {
    VulkanThread(WeakReference<TrackAsiaVulkanSurfaceView> surfaceViewWeakRef) {
        ...
        synchronized (renderThreadManager) {
          while (true) {
            ...
            if (paused && graphicsSurfaceCreated) {
              TrackAsiaVulkanSurfaceView view = mSurfaceViewWeakRef.get();
              if (view != null) {
                destroySurface = true;
    ...
    private WeakReference<TrackAsiaVulkanSurfaceView> mSurfaceViewWeakRef;
  }
}
