 ...
 * {@link TrackAsiaSurfaceView} specifics to render the map.
 *
 * @see MapRenderer
 */
public class SurfaceViewMapRenderer extends MapRenderer {
  ...
  @NonNull
  protected final TrackAsiaSurfaceView surfaceView;

  public SurfaceViewMapRenderer(Context context,
                                TrackAsiaSurfaceView surfaceView,
                                String localIdeographFontFamily) {
    super(context, localIdeographFontFamily);
    this.surfaceView = surfaceView;

    surfaceView.setDetachedListener(new TrackAsiaSurfaceView.OnSurfaceViewDetachedListener() {
      @Override
