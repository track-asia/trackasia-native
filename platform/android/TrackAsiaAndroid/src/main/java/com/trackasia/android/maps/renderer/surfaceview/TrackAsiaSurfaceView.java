...
public abstract class TrackAsiaSurfaceView extends SurfaceView implements SurfaceHolder.Callback2 {

  protected static final String TAG = "TrackAsiaSurfaceView";
   ...
   */
  public TrackAsiaSurfaceView(Context context) {
    super(context);
    init();
  }
   ...
   * must call {@link #setRenderer} to register a renderer.
   */
  public TrackAsiaSurfaceView(Context context, AttributeSet attrs) {
    super(context, attrs);
    init();
  }
   ...
   * not normally called or subclassed by clients of TrackAsiaSurfaceView.
   */
   ...
   * called or subclassed by clients of TrackAsiaSurfaceView.
   */
  @Override
  ...
  /**
   * Listener interface that notifies when a {@link TrackAsiaSurfaceView} is detached from window.
   */
  public interface OnSurfaceViewDetachedListener {

    /**
     * Called when a {@link TrackAsiaSurfaceView} is detached from window.
     */
