...
/**
    ...
    internal constructor(
        ...
        private fun containsLatitude(latitude: Double): Boolean = latitude <= latitudeNorth && latitude >= latitudeSouth

        private fun containsLongitude(longitude: Double): Boolean = longitude <= longitudeEast && longitude >= longitudeWest
        ...
        companion object {
            ...
            private fun checkParams(
                ...
                require(
                    !(
                        latNorth > GeometryConstants.MAX_LATITUDE ||
                            latNorth < GeometryConstants.MIN_LATITUDE ||
