...
/**
    ...
    internal constructor(
        ...
        override fun toString(): String =
            ("Target: " + target + ", Zoom:" + zoom + ", Bearing:" + bearing + ", Tilt:" + tilt + ", Padding:" + Arrays.toString(padding))
        ...
        class Builder {
            ...
            constructor(typedArray: TypedArray?) : super() {
                if (typedArray != null) {
                    bearing = typedArray.getFloat(R.styleable.trackasia_MapView_trackasia_cameraBearing, 0.0f).toDouble()
                    val lat = typedArray.getFloat(R.styleable.trackasia_MapView_trackasia_cameraTargetLat, 0.0f).toDouble()
                    val lng = typedArray.getFloat(R.styleable.trackasia_MapView_trackasia_cameraTargetLng, 0.0f).toDouble()
                    target = LatLng(lat, lng)
                    tilt = typedArray.getFloat(R.styleable.trackasia_MapView_trackasia_cameraTilt, 0.0f).toDouble()
                    zoom = typedArray.getFloat(R.styleable.trackasia_MapView_trackasia_cameraZoom, 0.0f).toDouble()
                }
            }
             ...
             */
            fun tilt(
                @FloatRange(from = TrackAsiaConstants.MINIMUM_TILT, to = TrackAsiaConstants.MAXIMUM_TILT) tilt: Double,
            ): Builder {
             ...
             */
            fun zoom(
                @FloatRange(from = TrackAsiaConstants.MINIMUM_ZOOM.toDouble(), to = TrackAsiaConstants.MAXIMUM_ZOOM.toDouble()) zoom:
                    Double,
            ): Builder {
                this.zoom = zoom
                return this
