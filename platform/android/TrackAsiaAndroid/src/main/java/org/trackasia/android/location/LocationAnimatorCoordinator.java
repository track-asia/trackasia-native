...
import static org.trackasia.android.location.TrackAsiaAnimator.ANIMATOR_PADDING;
...
final class LocationAnimatorCoordinator {
  ...
  private void createNewPaddingAnimator(@TrackAsiaAnimator.Type int animatorType,
