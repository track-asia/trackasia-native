...
object CameraUpdateFactory {
    ...
    class CameraPositionUpdate(
        ...
        override fun toString(): String {
            return (
                "CameraPositionUpdate{" + "bearing=" + bearing + ", target=" + target + ", tilt=" + tilt + ", zoom=" + zoom + ", padding=" +
                    Arrays.toString(
                        padding,
                    ) + '}'
            )
        ...
        override fun getCameraPosition(trackasiaMap: TrackAsiaMap): CameraPosition {
            ...
            return if (type != ZOOM_TO_POINT) {
                ...
                CameraPosition.Builder(
                    cameraPosition,
                ).zoom(transformZoom(cameraPosition.zoom)).target(trackasiaMap.projection.fromScreenLocation(PointF(x, y))).build()
            }
        }
