 ...
 */
public abstract class TrackAsiaAnimator<K> extends ValueAnimator implements ValueAnimator.AnimatorUpdateListener {
  ...
  public TrackAsiaAnimator(@NonNull @Size(min = 2) K[] values, @NonNull AnimationsValueChangeListener<K> updateListener,
                   int maxAnimationFps) {
