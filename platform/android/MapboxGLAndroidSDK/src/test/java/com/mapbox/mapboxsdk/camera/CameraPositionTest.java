...
public class CameraPositionTest {
  ...
  public void testTypedArrayBuilder() {
    ...
    when(typedArray.getFloat(R.styleable.trackasia_MapView_trackasia_cameraBearing, 0.0f)).thenReturn(bearing);
    when(typedArray.getFloat(R.styleable.trackasia_MapView_trackasia_cameraTargetLat, 0.0f)).thenReturn(latitude);
    when(typedArray.getFloat(R.styleable.trackasia_MapView_trackasia_cameraTargetLng, 0.0f)).thenReturn(longitude);
    when(typedArray.getFloat(R.styleable.trackasia_MapView_trackasia_cameraZoom, 0.0f)).thenReturn(zoom);
    when(typedArray.getFloat(R.styleable.trackasia_MapView_trackasia_cameraTilt, 0.0f)).thenReturn(tilt);
