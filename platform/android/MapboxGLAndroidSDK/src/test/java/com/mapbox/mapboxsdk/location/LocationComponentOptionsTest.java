...
public class LocationComponentOptionsTest {
  ...
  public void setUp() throws Exception {
    when(context.obtainStyledAttributes(R.style.trackasia_LocationComponent, R.styleable.trackasia_LocationComponent))
      .thenReturn(array);
    when(array.getResourceId(R.styleable.trackasia_LocationComponent_trackasia_foregroundDrawable, -1))
