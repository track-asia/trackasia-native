...
public:
    static constexpr auto Name() { return "org/track-asia-vn/android/offline/OfflineRegionDefinition"; };
...
public:
    ...
    static constexpr auto Name() {
        return "org/track-asia-vn/android/offline/"
...
public:
    using SuperTag = OfflineRegionDefinition;
    static constexpr auto Name() { return "org/track-asia-vn/android/offline/OfflineGeometryRegionDefinition"; };
