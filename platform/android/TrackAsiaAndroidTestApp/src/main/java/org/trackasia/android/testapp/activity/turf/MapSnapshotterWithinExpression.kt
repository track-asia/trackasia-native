...
import org.trackasia.android.testapp.databinding.ActivityMapsnapshotterWithinExpressionBinding
import org.trackasia.android.testapp.styles.TestStyles.getPredefinedStyleWithFallback
...
class MapSnapshotterWithinExpression : AppCompatActivity() {
                        ...
                        trackasiaMap.easeCamera(
                            CameraUpdateFactory.newCameraPosition(
                                CameraPosition.Builder().zoom(
                                    16.0,
                                ).target(LatLng(38.905156245642814, -77.06535338052844)).bearing(80.68015859462369).tilt(55.0).build(),
                            ),
                            1000,
                        )
    ...
    private fun setupStyle() {
        ...
        val options =
            MapSnapshotter.Options(binding.imageView.measuredWidth / 2, binding.imageView.measuredHeight / 2)
