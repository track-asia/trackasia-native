package com.trackasia.android.testapp.activity.events
...
import com.trackasia.android.tile.TileOperation
import java.util.*
...
class ObserverActivity :
    ...
    public override fun onPreCompileShader(
        id: Int,
        type: Int,
        defines: String,
    ) {
    ...
    public override fun onPostCompileShader(
        id: Int,
        type: Int,
        defines: String,
    ) {
    ...
    public override fun onGlyphsRequested(
    ...
    public override fun onGlyphsLoaded(
        fontStack: Array<String>,
        rangeStart: Int,
        rangeEnd: Int,
    ) {
    ...
    public override fun onSpriteRequested(
        id: String,
        url: String,
    ) {
    ...
    public override fun onSpriteLoaded(
        id: String,
        url: String,
    ) {
    ...
    public override fun onTileAction(
        op: TileOperation,
        x: Int,
        y: Int,
        z: Int,
