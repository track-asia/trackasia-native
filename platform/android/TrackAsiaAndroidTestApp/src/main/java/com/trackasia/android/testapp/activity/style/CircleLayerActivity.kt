...
class CircleLayerActivity :
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mapView.getMapAsync { map: TrackAsiaMap? ->
            ...
            trackasiaMap.setStyle(TestStyles.PROTOMAPS_WHITE) {
    ...
    companion object {
        ...
        const val URL_BUS_ROUTES =
            "https://s3.eu-central-1.amazonaws.com/trackasia-native/android-documentation-resources/bus-stops.geojson"
