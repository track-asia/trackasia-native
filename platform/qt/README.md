# TrackAsia GL Native for Qt

[![GitHub Action build status](https://github.com/trackasia/trackasia-gl-native/workflows/qt-ci/badge.svg)](https://github.com/trackasia/trackasia-gl-native/actions/workflows/qt-ci.yml) 
