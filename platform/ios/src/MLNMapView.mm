...
NSString * const MLNAnnotationSpritePrefix = @"com.trackasia.sprites.";
...
- (void)showAttribution:(id)sender
{
    ...
    NSString *actionSheetTitle = NSLocalizedStringWithDefaultValue(@"SDK_NAME", nil, nil, @"TrackAsia Native iOS", @"Action sheet title");
