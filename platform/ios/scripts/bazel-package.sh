...
while [[ $# -gt 0 ]]; do
   ...
   --link)
      ...
      ;;
   --help)
      echo "Build the trackasia xcframework using the bazel build files. You must install Bazelisk to build using this method."
