...
global.propertyDoc = function (propertyName, property, layerType, kind) {
    ...
    if (kind !== 'enum') {
        ...
        if ('original' in property) {
            ...
            doc += `\n\nThis attribute corresponds to the <a href="https://track-asia.com/maplibre-style-spec/#${anchor}"><code>${property.original}</code></a> layout property in the MapLibre Style Spec.`;
        }
