...
/**
 ...
 `MLNSphericalPosition` struct [radial coordinate, azimuthal angle, polar angle]
 ...
 when `MLNLight.anchor` is set to `MLNLightAnchorViewport` corresponds to the
 top of the viewport, or 0° when `MLNLight.anchor` is set to `MLNLightAnchorMap`
