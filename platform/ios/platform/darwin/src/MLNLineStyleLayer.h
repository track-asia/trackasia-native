...
/**
 ...
 `MLNVectorTileSource` object, or they can be `MLNPolyline`,
 `MLNPolylineFeature`, `MLNMultiPolyline`, or `MLNMultiPolylineFeature`
 instances in an `MLNShapeSource` or `MLNComputedShapeSource` object.
...
/**
 ...
 effect on lines defined by an `MLNShapeSource` whose
 `MLNShapeSourceOptionLineDistanceMetrics` option is set to `YES`.
