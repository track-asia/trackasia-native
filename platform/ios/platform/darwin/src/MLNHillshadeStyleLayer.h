...
/**
 ...
 loaded by an `MLNRasterDEMSource` object. For example, you could use a
 ...
 source, use an `MLNVectorTileSource` object in conjunction with several
 `MLNFillStyleLayer` objects.
