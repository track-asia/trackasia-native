...
/**
 ...
 an `MLNVectorTileSource` object, or they can be `MLNPolygon`,
 `MLNPolygonFeature`, `MLNMultiPolygon`, or `MLNMultiPolygonFeature` instances
 in an `MLNShapeSource` or `MLNComputedShapeSource` object.
