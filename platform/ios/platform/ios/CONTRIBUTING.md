# Contributing to TrackAsia GL Native for iOS

This document explains how to build TrackAsia GL Native for iOS from source. It is intended for advanced developers who wish to contribute to the library.
...
The code samples in the header files & [iOS API Documentation](https://track-asia.com/trackasia-gl-native/ios/api/) are generated by a unit test.
...
[Circle](https://track-asia.com/trackasia-gl-native/ios/api/Classes/MGLCircleStyleLayer.html), 
[Heatmap](https://track-asia.com/trackasia-gl-native/ios/api/Classes/MGLHeatmapStyleLayer.html), or 
[Line](https://track-asia.com/trackasia-gl-native/ios/api/Classes/MGLLineStyleLayer.html).  For more details see [Adding a code example](DEVELOPING.md#adding-a-code-example).
...
1. Provide full documentation comments. We use [jazzy](https://github.com/realm/jazzy/) to produce the documentation found in the SDK distribution and [on the website for this SDK](https://track-asia.com/trackasia-gl-native/ios/api/). We also recognize that many developers rely on Xcode’s Quick Help feature. jazzy supports Markdown formatting; however, Quick Help supports only [HeaderDoc](https://developer.apple.com/legacy/library/documentation/DeveloperTools/Conceptual/HeaderDoc/intro/intro.html) syntax and a subset of Doxygen syntax. For hyperlinks, use HTML syntax, which is recognized by both tools.
