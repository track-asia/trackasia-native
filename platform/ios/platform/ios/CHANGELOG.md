...
MapLibre welcomes participation and contributions from everyone. Please read [`Contributing Guide`](https://github.com/track-asia-vn/maplibre-native/blob/master/CONTRIBUTING.md) to get started.

## main

* 💥 Breaking: Changed the prefix of files, classes, methods, variables and everything from `MGL` to `MLN`. ([#919](https://github.com/track-asia-vn/maplibre-native/pull/919)).
...
* Fix missing attribution [#236](https://github.com/track-asia-vn/maplibre-native/pull/236)
* Fix logging format strings [#266](https://github.com/track-asia-vn/maplibre-native/pull/266)
* Implement map projection functionality [#254](https://github.com/track-asia-vn/maplibre-native/pull/254)
* Fix warnings, mainly casting to smaller types [#270](https://github.com/track-asia-vn/maplibre-native/pull/270)
...
* Remove account from xcconfig [#382](https://github.com/track-asia-vn/maplibre-native/pull/382)
* Remove observation of key-path [#380](https://github.com/track-asia-vn/maplibre-native/pull/380)
* Fix for "NSExpression function is forbidden" [#411](https://github.com/track-asia-vn/maplibre-native/pull/411)
* Xcode 14 compatibility [#494](https://github.com/track-asia-vn/maplibre-native/pull/494) [#599](https://github.com/track-asia-vn/maplibre-native/pull/599)

## 5.12.2 - December 02, 2021

### Improvements

* Exposes the windowBit value from zlib in the compress/decompress helper utils [#147](https://github.com/track-asia-vn/maplibre-native/pull/147)
* Fix camera paddings reset on map view gestures performing [#188](https://github.com/track-asia-vn/maplibre-native/pull/188)

## 5.12.1 - September 06, 2021

### Bug Fixes

* ScaleBar enhancements [#120](https://github.com/track-asia-vn/maplibre-native/pull/120), [#121](https://github.com/track-asia-vn/maplibre-native/pull/121)
* Invalid tile url template for MapLibre style [#107](https://github.com/track-asia-vn/maplibre-native/pull/107)
* Address crash when localFontFamilyName is nil [#109](https://github.com/track-asia-vn/maplibre-native/pull/109)
* Fix for annotations stuttering and drifting when panning [#113](https://github.com/track-asia-vn/maplibre-native/pull/113)
* Adjust local glyphs [#122](https://github.com/track-asia-vn/maplibre-native/pull/122)
* Return correct Mapbox TileServerOptions [#132](https://github.com/track-asia-vn/maplibre-native/pull/132)
...
* Fix build for Xcode 12.5 & 13-beta. [#153](https://github.com/track-asia-vn/maplibre-native/pull/153)

## 5.12.0 - June 29, 2021

### Features

* Added allowScrollGesturesDuringRotateOrZoom [#60](https://github.com/track-asia-vn/maplibre-native/pull/62)
...
* Fix map stuttering by switching render call to use setNeedsDisplay [#60](https://github.com/track-asia-vn/maplibre-native/pull/60)
* Dispatch to main queue, rather than global [#64](https://github.com/track-asia-vn/maplibre-native/pull/64)
* Use DisplayLink to prevent crashes in willResignActive [#68](https://github.com/track-asia-vn/maplibre-native/pull/68)
* Ignore sizing and positioning for hidden elements in assertions [#80](https://github.com/track-asia-vn/maplibre-native/pull/80)
* Disable map snapshots by default [#83](https://github.com/track-asia-vn/maplibre-native/pull/83)
...
* iOS performance improvements [#44](https://github.com/track-asia-vn/maplibre-native/pull/44)

### Other

* mapbox-gl-js submodule has been replaced with maplibre-gl-js
* Removed Mapbox Mobile Events and Telemetry [#7](https://github.com/track-asia-vn/maplibre-native/pull/7)
