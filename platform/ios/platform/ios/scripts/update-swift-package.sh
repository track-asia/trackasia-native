...
export DISTRIBUTION_GITHUB_REPO=https://api.github.com/repos/trackasia/trackasia-gl-native-distribution
...
MAPBOX_ZIP_FILE_URL="https://github.com/trackasia/trackasia-gl-native/releases/download/ios-v5.11.0/Mapbox-5.11.0.zip"
