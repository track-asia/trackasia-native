...
For more information, check out the [TrackAsia Native for iOS repository](https://github.com/trackasia/trackasia-native) and the [full changelog](https://github.com/trackasia/trackasia-native/blob/main/platform/ios/platform/ios/CHANGELOG.md) online.
...
We welcome your [bug reports, feature requests, and contributions](https://github.com/trackasia/trackasia-native/issues).
