...
type ExpiryData = {
  ...
  expires?: string | null; // TrackAsia can be a Date object
};

// copied from TrackAsia /util/ajax.ts
...
// for legacy trackasia-3 interop
...
/**
 * TrackAsia GL JS protocol. Must be added once globally.
 */
export class Protocol {
  ...
  /**
   * Initialize the TrackAsia PMTiles protocol.
   *
   ...
   *
   * For remote fetch sources, references in TrackAsia styles like pmtiles://http://...
