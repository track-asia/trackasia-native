...
function Loader(props: { file: PMTiles; mapHashPassed: boolean }) {
  const [tab, setTab] = useState("trackasia");

  let view: any;
  if (tab === "trackasia") {
    view = (
      <TrackasiaMap file={props.file} mapHashPassed={props.mapHashPassed} />
    );
  } else {
  ...
  return (
    <>
      <Toolbar aria-label="Formatting options">
        ...
        >
          <ToolbarToggleItem value="trackasia" aria-label="Right aligned">
            Map View
          </ToolbarToggleItem>
