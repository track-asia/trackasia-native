...
import trackasiagl, { MapGeoJSONFeature } from "trackasia-gl";
...
function TrackasiaMap(props: { file: PMTiles; mapHashPassed: boolean }) {
  ...
  useEffect(() => {
    ...
    map.addControl(new trackasiagl.NavigationControl({}), "bottom-left");
