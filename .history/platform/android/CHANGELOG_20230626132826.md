...
- 💥 Breaking: the `LocationEngine` implemented with Google Location Services has been removed to make MapLibre Native for Android fully FLOSS ([#379](https://github.com/track-asia/trackasia-native/issues/379)).
...
- Use maplibre docs for more links ([#354](https://github.com/track-asia/trackasia-native/pull/354))
- Use the MapLibre style spec docs website ([#353](https://github.com/track-asia/trackasia-native/pull/353))
...
- Replace Mapbox with MapLibre in README titles ([#297](https://github.com/track-asia/trackasia-native/pull/297))
- Rename MaptilerFileSource to MBTilesFileSource ([#198](https://github.com/track-asia/trackasia-native/pull/198))
- Changed missed MapBox reference to MapLibre ([#253](https://github.com/track-asia/trackasia-native/pull/253))
...
- remove Mapbox's in favor of MapLibre in attribution dialog [#160](https://github.com/track-asia/trackasia-native/pull/160)
...
Switching from mapbox-java libraries to [maplibre fork](https://github.com/track-asia/maplibre-java)
