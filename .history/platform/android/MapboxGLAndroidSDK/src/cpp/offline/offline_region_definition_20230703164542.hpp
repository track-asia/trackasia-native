...
public:
    static constexpr auto Name() { return "org/track-asia/android/offline/OfflineRegionDefinition"; };
...
public:
    ...
    static constexpr auto Name() {
        return "org/track-asia/android/offline/"
...
public:
    using SuperTag = OfflineRegionDefinition;
    static constexpr auto Name() { return "org/track-asia/android/offline/OfflineGeometryRegionDefinition"; };
