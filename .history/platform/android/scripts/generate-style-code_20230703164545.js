...
const lightJava = ejs.compile(fs.readFileSync('MapboxGLAndroidSDK/src/main/java/org/track-asia/android/style/light/light.java.ejs', 'utf8'), {strict: true});
const lightJavaUnitTests = ejs.compile(fs.readFileSync('MapboxGLAndroidSDKTestApp/src/androidTest/java/org/track-asia/android/testapp/style/light.junit.ejs', 'utf8'), {strict: true});
writeIfModified(`MapboxGLAndroidSDK/src/main/java/org/track-asia/android/style/light/Light.java`, lightJava({properties: lightProperties}));
writeIfModified(`MapboxGLAndroidSDKTestApp/src/androidTest/java/org/track-asia/android/testapp/style/LightTest.java`, lightJavaUnitTests({properties: lightProperties}));

// Java
const layerJava = ejs.compile(fs.readFileSync('MapboxGLAndroidSDK/src/main/java/org/track-asia/android/style/layers/layer.java.ejs', 'utf8'), {strict: true});
const layerJavaUnitTests = ejs.compile(fs.readFileSync('MapboxGLAndroidSDKTestApp/src/androidTest/java/org/track-asia/android/testapp/style/layer.junit.ejs', 'utf8'), {strict: true});

for (const layer of layers) {
  var srcDir = 'MapboxGLAndroidSDK/src/main/java/org/track-asia/android/style/layers/'
  var testDir = 'MapboxGLAndroidSDKTestApp/src/androidTest/java/org/track-asia/android/testapp/style/'
  if (layer.type === 'location-indicator') {
    srcDir = 'MapboxGLAndroidSDK/src/main/java/org/track-asia/android/location/'
    testDir = 'MapboxGLAndroidSDKTestApp/src/androidTest/java/org/track-asia/android/location/'
  }
...
const propertyFactoryTemplate = ejs.compile(fs.readFileSync('MapboxGLAndroidSDK/src/main/java/org/track-asia/android/style/layers/property_factory.java.ejs', 'utf8'), {strict: true});

var propertyFactorySrcDir = 'MapboxGLAndroidSDK/src/main/java/org/track-asia/android/style/layers/PropertyFactory.java'
writeIfModified(
...
var locationPropertyFactorySrcDir = 'MapboxGLAndroidSDK/src/main/java/org/track-asia/android/location/LocationPropertyFactory.java'
writeIfModified(
...
// Java Property
const enumPropertyJavaTemplate = ejs.compile(fs.readFileSync('MapboxGLAndroidSDK/src/main/java/org/track-asia/android/style/layers/property.java.ejs', 'utf8'), {strict: true});
writeIfModified(
    `MapboxGLAndroidSDK/src/main/java/org/track-asia/android/style/layers/Property.java`,
